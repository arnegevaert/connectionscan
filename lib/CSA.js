const fs = require('fs');
const wdc = require('./WalkingDistanceCalculator');
...
class CSA {
     ...
     */
    constructor(filename, interstopDistanceCalculator) {
...
let walkingDistanceCalculator = new wdc('data/test3.json');
let csa = new CSA('data/test3.json', walkingDistanceCalculator);
